...
const FAQS = [
  ...
  { q: 'How do I connect my WhatsApp account?', a: 'On the Dashboard, click "Generate QR Code" and scan it with your phone via WhatsApp > Settings > Linked Devices > Link a Device. Your account is connected immediately after scanning. Each connection is initiated manually by you — sessions are never restored automatically.', category: 'sessions' },
  ...
  { q: 'What happens to my connection when I close the browser?', a: 'WhatsApp Shield requires an active connection to run. To connect, you scan a QR code on the Dashboard. Your connection stays active until you disconnect or log out. When you return, you connect again by scanning a fresh QR code — no automatic session restoration is performed.', category: 'sessions' },
